...
const Home = () => {
  ...
  return (
    <div className='p-10'>
      ...
      <div className='w-full relative h-[80vh] flex-col items-center  flex  mt-10 '>

        <div id='img' className='h-[35vh] rounded-full shadow-lg shadow-black absolute top-[0] translate-y-[-50%] z-[2] overflow-hidden w-[35vh]'>
